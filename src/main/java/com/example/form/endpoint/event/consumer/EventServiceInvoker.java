package com.example.form.endpoint.event.consumer;

import com.example.form.PojaGenerated;
import com.example.form.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.example.form.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.example.form.service.event."
