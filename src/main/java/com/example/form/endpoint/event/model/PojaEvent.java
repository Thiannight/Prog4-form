...
import static com.example.form.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.example.form.PojaGenerated;
import com.example.form.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.example.form.event1";
    return "com.example.form.event2";
  }
}
